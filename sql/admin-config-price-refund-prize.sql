...
begin
  ...
  -- Se algum número deste cliente foi sorteado como ganhador, preserve o histórico do sorteio
  -- (nome, telefone, número e data), mas remova os vínculos que impedem a exclusão/reembolso.
